<?php
	...
	require('app_config/config.inc.php');
	require('app_config/functions.php');
...
<body>
	...
	<section class="class_1" >
		<?php include('app_config/header.inc.php') ?>
		<div class="class_11" >
			<?php include('app_config/success.alert.inc.php') ?>
			<?php include('app_config/fail.alert.inc.php') ?>
			<h1 class="class_41"  >
				Posts
			</h1>
		...
		<br><br>
		<?php include('app_config/signup.inc.php') ?>
		<?php include('app_config/login.inc.php') ?>
		<?php include('app_config/post.edit.inc.php') ?>
	</section>
